...
# Data Load
df_states = pd.read_csv("./database/df_states.csv")
df_brasil = pd.read_csv("./database/df_brasil.csv")
...
# Map Style
fig.update_layout(
                # mapbox_accesstoken=token(Your access in Mapbox API)
        ...
        dbc.Row([
            dbc.Col([
                    html.Div([
                        ...
                        html.H5(children="Painel de Informacões COVID-19"),
                    ...
                    dbc.Row([
                        dbc.Col([dbc.Card([   
                                dbc.CardBody([
                                    ...
                                    html.Span("Acompanhamento", className="card-text"),
                                    html.H5(id="em-acompanhamento-text"),
                                    ])
                                ], color="light", outline=True, style={"margin-top": "5px",
                        ...
                        dbc.Col([dbc.Card([   
                                dbc.CardBody([
                                    ...
                                    html.Span("Novos casos", className="card-text"),
...
# Update info location, click event
